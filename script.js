    ...
    card.addEventListener("mouseenter", () => {
        ...
        requestAnimationFrame(() => {
            ...
            title.style.transition =
                `transform ${Math.max(distance * 20, 1500)}ms linear`;
...
const games = [
    ...
    {id:"killer",name:"🔪 KILLER",placeId:127829441663442,roles:["Tester"],visible:true},
    ...
    {id:"mc",name:"Mine & Craft",placeId:82792613389716,roles:["Tester"],visible:true},
...
function card(g) {
    ...
    d.innerHTML = `
        <img id="${g.id}-icon" class="portfolio-image">
        ...
        <div class="portfolio-content">
            ...
            <p>Total Visits</p>
            <strong id="${g.id}-visits">Loading...</strong>
        </div>
    `;
